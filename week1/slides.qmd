...
\small\vspace*{-0.2cm}
  ...
  1. Google closing stock price in $US on 17 Aug
  2. The difference in runs scored between Australia and Bangladesh in the second cricket test to be held 22-26 Aug, Mackay. Give result as (Australia total minus Bangladesh total)
  3. Maximum temperature in Celsius at Melbourne airport on 13 Sep
  4. Google closing stock price in $US on 5 Oct
  5. The seasonally adjusted estimate of total employment for Sep 2026. ABS CAT 6202, to be released on 15 Oct
