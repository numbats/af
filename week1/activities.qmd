...
apply_checks(
  c(
    ...
    "You should specify which column provides the time of the measurements with `index`." = !search_ast(ql_ast(), .fn = as_tsibble, index = Date),
  ...
  .msg_correct = if (!is_yearquarter(aus_accommodation$Date)) "Great, you've got a tsibble!<br>Although something doesn't look right - check the frequency of the data, why isn't it quarterly?" else "That's correct! Well done."
)
```
